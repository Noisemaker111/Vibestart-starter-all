...
import { processIdea } from "@pages/utils/integrationLLM";
import { DEFAULT_MODEL } from "@pages/utils/integrationLLM";
...
import { consumeLocalToken } from "@pages/utils/rateLimit";
import { usePostHog } from "posthog-js/react";
import VibeStartMainInfo from "./components/VibeStartMainInfo";
import HomeIdeaCard from "./components/HomeIdeaCard";
import VibeStartOtherInfo from "./components/VibeStartOtherInfo";
import HomeOtherCTA from "./components/HomeOtherCTA";

// Local constant – rotate placeholder suggestions every 4 seconds
const HOME_PLACEHOLDER_ROTATE_MS = 4000 as const;
