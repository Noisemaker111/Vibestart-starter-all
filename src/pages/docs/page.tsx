...
import BuildTab from "src/pages/docs/components/BuildTab";
import PlatformChip from "@pages/components/PlatformChip";
import SideBar from "src/pages/docs/components/SideBar";
import { CLAUDE_SYSTEM_RULES } from "@shared/systemRulesClaude";
import { GEMINI_SYSTEM_RULES } from "@shared/systemRulesGemini";
...
export default function Docs() {
  ...
  // --- Static rule file content (no editing needed) ---
