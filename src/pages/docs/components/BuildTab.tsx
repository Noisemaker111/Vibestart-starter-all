...
import { PROJECT_STRUCTURE_MDC, TECH_STACK_MDC } from "@shared/systemRulesCursor";

// Test components for individual integrations
import TestIntegrations from "@pages/test/page";

import { supabase } from "@shared/supabase";
import { dispatchClearTests } from "@pages/utils/testIntegrationEvents";
import {
  promptCursorSetup,
  promptClaudeSetup,
  promptGeminiSetup,
} from "@shared/promptVibestartSetup";
...
const BuildTab: FC<BuildTabProps> = ({ idea, platformLabel, integrationKeys, onIntegrationKeysChange, onPlatformChange, className }) => {
  ...
  // ---------------------------------------------------------------------------
  const projectStructureMdc = PROJECT_STRUCTURE_MDC;
  const techStackMdc = TECH_STACK_MDC;
